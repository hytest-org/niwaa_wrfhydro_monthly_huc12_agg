...
geogrid = r'/glade/p/cisl/nwc/nwmv21_finals/CONUS/DOMAIN_FinalParams/geo_em.d01.conus_1km_NWMv2.1_XLATC_XLONC.nc' # v3.0 - same as v2.1

# NWM LDASOUT Spatial Metadata file - contains spatial metadata for the LSM grid
geogrid_SM = r'/glade/p/cisl/nwc/nwmv21_finals/CONUS/DOMAIN_FinalParams/GEOGRID_LDASOUT_Spatial_Metadata_1km_NWMv2.1.nc' # v3.0 - same as v2.1

# NWM Fulldom_hires netCDF file - contains routing ariables on the routing grid
...
fulldom = r'/glade/p/cisl/nwc/nwmv30_calibration/regionalization/NWM_V3_retro_MixMatch/Fulldom_hires_netcdf_file_250m_NWMv3.0_CombByHUC8.nc'  #v3.0

# NWM channel routing parameters (RouteLink)
#chrt_parms = r'/glade/p/cisl/nwc/nwmv21_finals/CONUS/DOMAIN_FinalParams/RouteLink_NWMv2.1_fromVars.nc'
chrt_parms = r'/glade/p/cisl/nwc/nwmv30_finals/CONUS/DOMAIN_DefaultParams/RouteLink_NWMv3.0.nc' # v3.0

# NWM groundwater bucket parameters (GWBUCKPARM)
#gw_parms = r'/glade/p/cisl/nwc/nwmv21_finals/CONUS/DOMAIN_FinalParams/GWBUCKPARM_FullRouting_NWMv2.1.nc'
gw_parms = r'/glade/p/cisl/nwc/nwmv30_calibration/regionalization/NWM_V3_retro_MixMatch/GWBUCKPARM_NWMv3.0_CombByHUC8.nc'  #v3.0

# NWM lake parameter file (LAKEPARM)
#lk_parms = r'/glade/p/cisl/nwc/nwmv21_finals/CONUS/DOMAIN_FinalParams/LAKEPARM_NWMv2.1.nc'
lk_parms = r'/glade/p/cisl/nwc/nwmv30_finals/CONUS/DOMAIN_DefaultParams/LAKEPARM_NWMv3.0.nc'  #v3.0

# NWM Lake Link Type file (LAKE_TYPES.nc)
#lk_types = r'/glade/p/cisl/nwc/nwmv21_finals/CONUS/DOMAIN_FinalParams/LAKE_TYPES_NWMv2.1.nc' # v2.1
lk_types = r'glade/p/cisl/nwc/nwmv30_finals/CONUS/DOMAIN_DefaultParams/LAKE_TYPES_NWMv3.0.nc' # v3.0

# Soil properties file
#soil_props = r'/glade/p/cisl/nwc/nwmv21_finals/CONUS/DOMAIN_FinalParams/soil_properties_FullRouting_NWMv2.1_new_snow_params.nc'  #v2.1
soil_props = r'/glade/p/cisl/nwc/nwmv30_calibration/regionalization/NWM_V3_retro_MixMatch/soil_properties_NWMv3.0_CombByHUC8.nc' # v3.0

# --- End Domain files --- #

# --- Retrospective model output files --- #

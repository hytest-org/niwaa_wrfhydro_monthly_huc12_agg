...
#r'/glade/p/cisl/nwc/nwmv21_finals/CONUS/DOMAIN_FinalParams/geo_em.d01.conus_1km_NWMv2.1_XLATC_XLONC.nc' # v3.0 - same as v2.1
...
#r'/glade/p/cisl/nwc/nwmv21_finals/CONUS/DOMAIN_FinalParams/GEOGRID_LDASOUT_Spatial_Metadata_1km_NWMv2.1.nc' # v3.0 - same as v2.1
...
#r'/glade/p/cisl/nwc/nwmv30_finals/CONUS/DOMAIN_DefaultParams/RouteLink_NWMv3.0.nc' # v3.0
...
#r'/glade/p/cisl/nwc/nwmv30_calibration/regionalization/NWM_V3_retro_MixMatch/GWBUCKPARM_NWMv3.0_CombByHUC8.nc'  #v3.0
...
#r'/glade/p/cisl/nwc/nwmv30_calibration/regionalization/NWM_V3_retro_MixMatch/soil_properties_NWMv3.0_CombByHUC8.nc' # v3.0
